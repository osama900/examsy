...
async function fetchQuestionsFromGoogleSheet() {
  try {
    const response = await fetch(
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vSwWAPQzRW2-CBPR5dfsr_XGX02xKEhhDC4Ilmr9mM--hMKc2xNprs24X2fEVkBPtIROxFByEL5AIL_/pub?output=csv"
    );
...
function submitExam() {
  ...
  const examData = {
    ...
    testName: testName, // إضافة اسم الاختبار
    score: totalScore,
    maxScore: maxScore, // إضافة العلامة القصوى
    date: now.toLocaleDateString(),
    time: now.toLocaleTimeString(),
